        ...
        <div className="md:flex md:flex-row gap-5 grid grid-cols-2">
          ...
          <Checkbox
            ...
            {selectedType === "chemical" && (
              ...
              <Typography className=" text-md mt-10 font-bold">
                Petrochemical and Carbon Black Production
                </Typography>
                <div className="flex flex-col md:flex-row mt-4"> 
                <Typography className=" text-md whitespace-nowrap mr-2">
                Methanol (tons)
                </Typography>
                <Input
                  type="number"
                  placeholder="0"
                  className="!border-t-blue-gray-200 focus:!border-t-gray-900 w-40"
                  labelProps={{
                    className: "before:content-none after:content-none",
                  }}
                />
            ...
            <div className="md:flex md:flex-row mt-4 flex-col">
            <Typography className=" text-md whitespace-nowrap mr-2">
                Carbon black (tons)
                </Typography>
                <Input
