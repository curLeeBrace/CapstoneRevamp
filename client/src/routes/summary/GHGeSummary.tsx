...
useEffect(()=>{
  ...
  const TABLE_HEAD = [
   ...
   return (
    <div className='p-2 mt-2 flex flex-col w-full'>
          <div className='flex w-1/2 bg-yellow-500 justify-around self-center'> 
            <div>
              {
                 ...
                 {/* ETO YUNG GINAWA KONG SUMMARY TABLE */}
          {
            ...
            totalGHGEmissions={tablecontent.totalGHGe.toString()}
